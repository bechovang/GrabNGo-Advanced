...
def create_customer_qr(customer_id, name=None, phone=None, output_dir="qr_codes"):
    """
...
def create_multiple_qr_codes(start_id=1, count=10, prefix="CUST_"):
    ...
    for i in range(start_id, start_id + count):
        ...
        create_customer_qr(customer_id)
    
    print(f"✅ Created {count} QR codes in 'qr_codes' directory")
...
def main():
    ...
    # Batch mode
    if args.batch:
        create_multiple_qr_codes(args.start_id, args.batch, args.prefix)
        return
